  ...
  <table class="table table-striped">
    <thead class="thead-dark">
      <tr>
        ...
        <th width="5%">Actions</th> <!-- New column for delete button -->
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $row["car_availability"]; ?></td>
       <td>
        <form method="post" action="delete_entry.php"> <!-- Assuming you have a separate PHP file for deletion -->
          <input type="hidden" name="car_id" value="<?php echo $row['car_id']; ?>"> <!-- Assuming your entry has an 'car_id' field -->
