...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.2/html2pdf.bundle.js"></script>
    ...
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/jspdf@2.4.0/dist/jspdf.umd.min.js"></script>
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <script>
        ...
        document.getElementById('downloadInvoiceBtn').addEventListener('click', function () {
            ...
            pdf.text("Vehicle Name: <?php echo $car_name; ?>", 20, 30);
            pdf.text("Vehicle Number: <?php echo $car_nameplate; ?>", 20, 40);
            // Add more details as needed

            // Save the PDF with a unique name
            pdf.save('invoice_<?php echo $id; ?>.pdf');
        });
    </script>
</body>
<?php } else { ?>
